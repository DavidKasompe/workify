  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <DragOverlay>
          {activeTask && (
            <div className="p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-lg max-w-xs">
...
function DroppableColumn({
  ...
  return (
    <div className="bg-gray-50/80 dark:bg-gray-800/80 rounded-lg border border-gray-200 dark:border-gray-700 p-4 flex flex-col">
      <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-4 flex items-center justify-between">
        {column.name}
      ...
      >
        ...
        {isOver && tasks.length === 0 && (
          <div className="h-full border-2 border-dashed border-indigo-200 dark:border-indigo-700 rounded-lg"></div>
        )}
      </div>
    </div>
  );
